            ...
            res.on('end', () => {
                try {
                    if (args[0] == "skywars" || args[0] == "sw") {
                        ...
                        if (stats.player == null) return message.channel.send("Something went terribly wrong.\nThe reason may be that you tried to search the same person often, the Hypixel API doesn't all that.");
                    ...
                    message.channel.send("Something went terribly wrong.\nThe reason may be that you tried to search the same person often, the Hypixel API doesn't all that.");
                }
